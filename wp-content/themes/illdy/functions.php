...
if(!function_exists('illdy_enqueue_stylesheets')) {
	...
	function illdy_enqueue_stylesheets() {
		...
		wp_enqueue_style( 'illdy-style', get_stylesheet_uri(), array(), '1.0.15', 'all' );
	}
}
...
if(!function_exists('illdy_enqueue_javascripts')) {
	...
	function illdy_enqueue_javascripts() {
		...
		wp_enqueue_script( 'illdy-plugins', get_template_directory_uri() . '/layout/js/plugins.min.js', array( 'jquery' ), '1.0.15', true );
		wp_enqueue_script( 'illdy-scripts', get_template_directory_uri() . '/layout/js/scripts.min.js', array( 'jquery' ), '1.0.15', true );
